...
PauseExecution.prototype._init = function () {
  ...
  this._eventBus.on(RESTART_COUNTER_EXAMPLE_VISUALIZATION, () => {
    ...
    domClasses(this._canvasParent).remove("paused");
    this._paletteEntry.innerHTML = PAUSE_MARKUP;
    this._isPaused = false;
  });
};
...
PauseExecution.prototype.pause = function () {
  ...
  domClasses(this._canvasParent).add("paused");

  this._paletteEntry.innerHTML = PLAY_MARKUP;
