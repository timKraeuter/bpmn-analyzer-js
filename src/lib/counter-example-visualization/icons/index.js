...
const LogIcon = createIcon(LOG_SVG);
const InfoIcon = createIcon(INFO_SVG);
const TimesIcon = createIcon(TIMES_SVG);
const RestartIcon = createIcon(RESTART_SVG);
const PauseIcon = createIcon(PAUSE_SVG);
const PlayIcon = createIcon(PLAY_SVG);

const TachometerIcon = createIcon(TACHOMETER_SVG);

const AngleRightIcon = createIcon(ANGLE_RIGHT_SVG);

const CheckCircleIcon = createIcon(CHECK_CIRCLE_SVG);
